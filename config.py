...
API_ID = int(getenv("API_ID","9048480"))
API_HASH = getenv("API_HASH","df289c25d9632b05f47c233c05d786bb")

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("BOT_TOKEN","5520950153:AAFgL2YRE3cFEya_y4uLb21whV8ldIyp2zs")
...
LOGGER_ID = int(getenv("LOGGER_ID","1002054824696-"))

# Get this value from @FallenxBot on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 6264668799))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/K_OK0KK")
...
TG_AUDIO_FILESIZE_LIMIT = int(getenv("TG_AUDIO_FILESIZE_LIMIT", 6264668799))
TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", 1073741824))
# Checkout https://www.gbmb.org/mb-to-bytes for converting mb to bytes


# Get your pyrogram v2 session from @JG0Bot on Telegram
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/f68bd01bad069f7be552e.jpg"
)
PING_IMG_URL = getenv(
